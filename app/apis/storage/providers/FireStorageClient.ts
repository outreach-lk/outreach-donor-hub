import { FileMetadata, RemoteFileUploadResDto, FileDto, RemoteFileDeleteResDto } from "../../../types/dtos/remoteFileDtos";
import { IFileStorageClient } from "../storage.client.interface";
